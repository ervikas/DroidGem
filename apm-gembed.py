...
gdot_path = "./dot_output"
g2v_name_output = "./apm_output/g2v_names_pred.txt"
g2v_embd_output = "./apm_output/g2v_embeddings_pred.txt"
apm_out_dir = os.path.dirname(g2v_embd_output)


if not os.path.exists(apm_out_dir):
    os.makedirs(apm_out_dir)
